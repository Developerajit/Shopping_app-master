                ...
                children: <Widget>[
                  Card(
                      ...
                      child: ClipRRect(
                        ...
                        child: Stack(
                          children: <Widget>[
                            Image.network('https://assets.abfrlcdn.com/img/app/product/3/352427-1742906-large.jpg',height: 150,width: 200,fit: BoxFit.fitWidth,),
                            Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Stack(
                          children: <Widget>[
                            ...
                            Container(
                              margin: EdgeInsets.only(top: 152,left: 5),
                              child: Text('₹549',style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.bold),),
                            )
                          ],
                        ),
                      )
                      ...
                      child: ClipRRect(
                        ...
                        child: Stack(
                          children: <Widget>[
                            ...
                            Container(
                              margin: EdgeInsets.only(top: 152,left: 5),
                              child: Text('₹559',style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.bold),),
                            )
                          ],
                        ),
                      )
                      ...
                      child: ClipRRect(
                        ...
                        child: Stack(
                          children: <Widget>[
                            ...
                            Container(
                              margin: EdgeInsets.only(top: 152,left: 5),
                              child: Text('₹670.81',style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.bold),),
                            )
                          ],
                        ),
                      )
                      ...
                      child: ClipRRect(
                        ...
                        child: Stack(
                          children: <Widget>[
                            ...
                            Container(
                              margin: EdgeInsets.only(top: 152,left: 5),
                              child: Text('₹849',style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.bold),),
                            )
                          ],
                        ),
                      )
                  ...
                  Card(
                      ...
                      child: ClipRRect(
                        ...
                        child: Stack(
                          children: <Widget>[
                            Image.network('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXTBibud5ZKGH2WkziW98vAcdeIuuXElEK9xD4NTPjhfw81NO9UA&s',height: 150,width: 200,fit: BoxFit.fitWidth,),
                            Container(
                              margin: EdgeInsets.only(top: 160,left: 90),
                              height: 30,width: 90,
                              child: Stack(
                            ...
                            Container(
                              margin: EdgeInsets.only(top: 152,left: 5),
                              child: Text('₹1249',style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.bold),),
                            )
                          ],
                        ),
                      )
                      ...
                      child: ClipRRect(
                        ...
                        child: Stack(
                          children: <Widget>[
                            ...
                            Container(
                              margin: EdgeInsets.only(top: 152,left: 5),
                              child: Text('₹249',style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.bold),),
                            )
                          ],
                        ),
                      )
